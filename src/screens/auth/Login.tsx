            ...
            <View className="flex-1 bg-white px-6 pt-[35px] rounded-[24px] overflow-hidden">
                ...
                >
                    ...
                    <TextInput
                        ...
                        className={`font-zen border rounded-xl p-4 mb-2 w-full max-w-md self-center text-base ${emailError ? 'border-error' : 'border-gray-300 focus:border-brand-accent-green'
                            }`}
